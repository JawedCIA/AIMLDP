...
model = train("./poison_data_50.csv")
acc = evaluate(model, "./test.csv")
print(f"Model accuracy: {round(acc*100, 2)}%")

#message = "Congratulations! You won a prize. Click here to claim: https://bit.ly/3YCN7PF."
messages=["Congratulations! You won a prize. Click here to claim: https://bit.ly/3YCN7PF. "]
#"Your board is working fine. The issue of overheating is also reslove. But still software inst is pending."]
